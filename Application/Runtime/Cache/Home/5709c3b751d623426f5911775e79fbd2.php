               ...
               <div class="wrapper-md">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body b-b b-light">
                      ...
                      <form action="/tp2018.4.24test/index.php/Home/Index/books_search" method="post">
                      <strong>搜索书名:</strong> 
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/tp2018.4.24test/index.php/Home/Index/addbooks">
                      ...
                      <table class="table m-b-none" ui-jq="footable" data-filter="#filter" data-page-size="5">
                        ...
                        <tbody>
                           ...
                           <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              <form action="/tp2018.4.24test/index.php/Home/Index/books_exe" method="post">
                                  <td><?php echo ($vo["id"]); ?></td>
                                  <td title="点击查看详情"><a href="/tp2018.4.24test/index.php/Home/Index/books_exe/id/<?php echo ($vo["id"]); ?>" > <?php echo ($vo["bookname"]); ?></a></td></form>
                                  <td><?php echo ($vo["author"]); ?></td>
                                  <th><?php echo ($vo["publisher"]); ?></th>
                                  <td><?php echo ($vo["booktype"]); ?></td>
                                  <td><i class="fa fa-cny"></i><?php echo ($vo["price"]); ?></td>
                                  <td><?php echo ($vo["cover"]); ?></td>
                                  <td>  <form action="/tp2018.4.24test/index.php/Home/Index/books_exe" method="post">
                                  <button type="submit" class="btn btn-rounded btn-sm btn-info" value="<?php echo ($vo["id"]); ?>" name="xq"><i class="icon-eyeglasses"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 详情</font></font></button>
                                  <button type="submit" class="btn btn-rounded btn-sm btn-warning" value="<?php echo ($vo["id"]); ?>" name="xg"><i class="icon-note"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 修改</font></font></button>
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              <button type="submit" class="btn btn-primary" name="sc" value="<?php echo ($vo["id"]); ?>">
                                                心意已决
                                              </button>
                                            </div>
                                          </div><!-- /.modal-content -->
