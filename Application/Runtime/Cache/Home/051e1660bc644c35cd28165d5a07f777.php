                     ...
                     <div class="clear m-b">  
                      <div class="col-sm-12" >
                        <div class="panel panel-default">
                          ...
                          <form class="bs-example form-horizontal" method="post" action="/tp2018.4.24test/index.php/Home/Index/goxg" >
                            <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>图书ID：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($id); ?></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>图书名：</strong></label>
                              <div class="col-lg-10">
                                 <span class="help-block m-b-none"><?php echo ($bookname); ?></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>作者：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($author); ?></span>
                              </div>
                            </div>
                             <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>出版社：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($publisher); ?></span>
                              </div>
                            </div>
                             <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>图书类型：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($booktype); ?></span>
                              </div>
                            </div>
                             <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>图书价格：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><i class="fa fa-cny"></i><?php echo ($price); ?></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>封面图：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($cover); ?></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label"><strong>此书简介：</strong></label>
                              <div class="col-lg-10">
                                <span class="help-block m-b-none"><?php echo ($synopsis); ?></span>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-lg-offset-2 col-lg-10">
                                <button type="submit" class="btn btn-sm btn-info btn-rounded" value="<?php echo ($id); ?>" name="goxg">修改图书信息</button><a href="books">
