               ...
               <div class="wrapper-lg bg-white-opacity">
                 <div class="row m-t">
                   <div class="col-sm-12">
                     <div class="clear m-b">  
                      <div class="col-sm-12" >
                      <a href class="thumb-lg pull-left m-r col-sm-4">
                      ...
                      <div class="m-b m-t-sm" >
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading font-bold">修改用户信息</div>
                          <div class="panel-body">
                          <form class="bs-example form-horizontal" action="/tp2018.4.24test/index.php/Home/Index/xguserdata_exe" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              <label class="col-lg-2 control-label">密码：</label>
                              <div class="col-lg-10">
                                <input type="text" class="form-control rounded" placeholder="Password" name="userpwd"  value="<?php echo ($userpwd); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label">确认密码：</label>
                              <div class="col-lg-10">
                                <input type="password" class="form-control rounded" placeholder="Duplicate Password" name="userpwd1">
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <div class="checkbox">
                                    <label class="i-checks">
                                      <input type="radio" value="男" name="usersex" <?php echo ($sex1); ?>>
                                      <i></i>
                                        男
                                    </label>
                                    <label class="i-checks">
                                      <input type="radio" value="女" name="usersex" <?php echo ($sex2); ?>>
                                      <i></i>
                                        女
                                    </label>
                                  </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" class="form-control rounded" placeholder="Phone number" name="usertel" value ="<?php echo ($usertel); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-lg-2 control-label">爱好：</label>
                              <div class="col-lg-10">
                                <textarea class="form-control " rows="6" placeholder="Type your hobby" name="useraihao"><?php echo ($useraihao); ?></textarea>
                              </div>
                            </div>
                            <!-- 修改头像 -->
                               <link rel="stylesheet" type="text/css" href="https://res.wx.qq.com/open/libs/weui/1.1.2/weui.min.css">
  <script type="text/javascript" src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
  <script type="text/javascript" src="/tp2018.4.24test/Public/js/lrz.bundle.js"></script>
                 ...
                 <label class="col-lg-2 control-label">头像上传：</label>
                      <div class="col-lg-10">
                          ...
                          <ul class="weui-uploader__files" id="uploaderFiles" style="float: left;">
                             <li id="img1" class="weui-uploader__file" style="background-image:url(/tp2018.4.24test/Public/txphoto/<?php echo ($userphoto); ?>)"></li>
                          </ul>
                          <div class="weui-uploader__input-box" style="float: left;">
                              <input type="hidden" name="myfile"  value="<?php echo ($userphoto); ?>">
                            ...
                            <div class="">
                              <div class="col-md-offset-2 col-lg-8">
                                <button type="submit" class="btn btn-sm btn-success" name="xguserdata_exe">确认修改</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="button" class="btn btn-sm btn-info" name="return" value="返回" onclick="javascript:history.back(-1);" >我不想改了</button>
                              </div>
                            </div>
                          </form>
                        </div>
